...
public class UnboundedSpatialTable : IDisposable {
    ...
    private static ProfilerMarker QueryMarker  = new ProfilerMarker("QueryEntities");
    private static ProfilerMarker RehashMarker = new ProfilerMarker("RehashEntities");
